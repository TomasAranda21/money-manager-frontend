...
const NewPass = () => {
  ...
  return (
    ...
    <FormForgotPassword  sendEmail ={ false } functionUser={newPassword} alert={alert} />
    
    : <h1 className="text-center uppercase text-2xl text-red-700">There was an error in the link</h1>
    }
