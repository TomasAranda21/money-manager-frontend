...
const InputsForm = ({name, value, error, touched, onBlur, onChange, type, placeholder}) => {
    ...
    <div className="flex flex-col gap-1">
        <label htmlFor={name} className="capitalize font-semibold">{name}</label>
         ...
         <input 
            ...
            ${error && touched ? "border-1 focus:border-red-500 border-red-500" : "focus:border-indigo-500 "}`}
