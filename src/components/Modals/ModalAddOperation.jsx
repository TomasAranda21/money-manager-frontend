...
const ModalAddOperation = ({setViewModal, addOperation}) => {
  ...
  return (
    ...
    <div className="absolute top-0 w-full h-screen left-0 backdrop-brightness-50">
     ...
     <div className="shadow-2xl bg-gray-100 flex justify-center my-32 w-1/3 mx-auto py-20 relative rounded-md border-2 border-teal-200">

        {isExpense === true || isIncome === true ?

            <div className="absolute top-0 left-0 p-2 px-5 font-bold">
