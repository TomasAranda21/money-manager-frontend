  ...
  return (
    ...
    >
        {({values, errors, touched, handleChange, handleSubmit, handleBlur}) => (
            <form action="" onSubmit={handleSubmit} className="flex flex-col gap-6 py-10 ">
            ...
            <div className="flex items-center gap-2 mx-auto">
                ...
                <div className="h-14 w-14 md:h-20 md:w-20 overflow-hidden shadow-2xl border-2 border-orange-500 rounded-full">
                        {img === 'img' || img == undefined ?  <img src="https://res.cloudinary.com/dkxm9njd6/image/upload/v1656799468/user_fjmynn.png" alt="" className=" object-cover"/> 
