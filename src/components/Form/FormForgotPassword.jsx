    ...
    <div className="shadow-2xl bg-gray-100 p-5 md:p-16  w-full sm:w-2/3 xl:w-1/3 py-16 mt-10 mx-auto border-2 border-sky-600">
        ...
        validate={({email, password, newPassword}) =>{
            ...
            if(!sendEmail){
                ...
                if(!password){
                    errors.password = 'Password must contain at least 6 characters and must contain at least one capital letter and one numeric character. '
        ...
        onSubmit={async (values, {resetForm}) => {
            ...
            functionUser({email: emailtoLowerCase, password: values.password})
            ...
            {({values, errors, touched, handleChange, handleSubmit, handleBlur}) => (
                ...
                <form action="" onSubmit={handleSubmit} className="flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-2 text-center">
                        ...
                        {sendEmail ? 'send email with instructions' : 'new password'}</h2>

                        <p className="">
                            {sendEmail ?  "Regain your Access and DO NOT lose your account." : "Reset your password and DO NOT lose access to your account."}
                        </p>
                ...
                {sendEmail ?
                    <div>
                        ...
                        <div className="mt-1">
                            {errors.email && touched.email && <AlertInputs error={errors.email}/>}
                        </div>
                  ...
                  :
                    <div className="flex flex-col gap-8">
                        ...
                        <div>
                            ...
                            />
                            <div className="mt-1">
                                {errors.password && touched.password && <AlertInputs error={errors.password}/>}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            />
                            <div className="mt-1">
                                {errors.newPassword && touched.newPassword && <AlertInputs error={errors.newPassword}/>}
                            </div>
                        </div>
                    ...
                    <div className=" text-center">
                        ...
                        <div>
                            ...
                            <LinkAuth text={"Don't have an account? "} text2='Create one now' nav={'/sign-in'} />
                            
                            <LinkAuth text={"You have an account? "} text2='Login now' nav={'/'} />
